...
async function seedDatabase() {
    try {
        ...
        await User_1.default.insertMany(userData);
        await Team_1.default.insertMany(teamData);
        await Activity_1.default.insertMany(activityData);
        await LeaderboardEntry_1.default.insertMany(leaderboardData);
        await Workout_1.default.insertMany(workoutData);
